...
Gem::Specification.new do |s|
  s.name = %q{ipvision-skates}
  s.version = "0.2.16"

  s.required_rubygems_version = Gem::Requirement.new(">= 0") if s.respond_to? :required_rubygems_version=
  s.authors = ["julien Genestoux", "S\303\270ren Blond Daugaard"]
  s.date = %q{2010-02-18}
  s.default_executable = %q{skates}
  s.email = %q{sbd@ipvision.dk}
  ...
  s.homepage = %q{http://github.com/daugaard/skates}
  s.rdoc_options = ["--charset=UTF-8"]
  s.require_paths = ["lib"]
  s.requirements = ["eventmachine", "yaml", "fileutils", "log4r", "nokogiri", "superfeedr-sax-machine", "templater", "optparse", "digest/sha1", "base64", "resolv", "utf8cleaner"]
  s.rubyforge_project = %q{skates}
  s.rubygems_version = %q{1.3.5}
  s.summary = %q{Skates is a framework to create EventMachine based XMPP External Components in Ruby. IPVision fork.}
  s.test_files = [
    "spec/em_mock.rb",
